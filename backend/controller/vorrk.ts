...
import systemPrompt from "../prompts/vorrk.ts";
...
export const sendVorrkResponse = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Error generating VORRK response:", error);
