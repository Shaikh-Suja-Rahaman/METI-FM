...
import systemPrompt from "../prompts/orim.ts";
...
export const sendOrimResponse = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Error generating ORIM response:", error);
