...
import systemPrompt from "../prompts/theSignal.ts";
...
export const sendSignalResponse = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Error generating THE SIGNAL response:", error);
