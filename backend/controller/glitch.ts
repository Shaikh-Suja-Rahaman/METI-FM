...
import systemPrompt from "../prompts/glitch.ts";
...
export const sendGlitchResponse = async (req: Request, res: Response) => {
  try {
    ...
    console.error("Error generating GLITCH response:", error);
